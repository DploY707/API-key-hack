package com.example.hacked_naver;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn2 = (Button) findViewById(R.id.ConvertBtn);

        btn2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                TextView koreanText = (TextView) findViewById(R.id.KoreanText);
                String keyword = koreanText.getText().toString();

                convertNaver(keyword);
            }
        });
    }
    ...
    public void searchNaver(final String searchObject) { // 검색어 = searchObject로 ;
        final String clientId = "pcs6neuWISbVB8JhJqA9";//애플리케이션 클라이언트 아이디값";
    ...
    public void convertNaver(final String convertObject) { // 검색어 = searchObject로 ;
        final String clientId = "pcs6neuWISbVB8JhJqA9";//애플리케이션 클라이언트 아이디값";
        final String clientSecret = "gHufl5Z8H1";//애플리케이션 클라이언트 시크릿값";
        final int display = 5; // 보여지는 검색결과의 수
        ...
        new Thread() {
            ...
            public void run() {
                try {
                    String text = URLEncoder.encode(convertObject, "UTF-8");
